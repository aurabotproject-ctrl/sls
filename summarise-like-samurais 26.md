...
>
> **Latest build:** the Story picker (choosing which of the 40 Bible Stories or 10 Japanese Legends stories to view) is now a **dropdown menu** instead of a long row of pill buttons, to tidy up the page as both curricula have grown. It's custom-styled to match the app's dark samurai theme (gradient fill, cream text, orange focus glow, CSS chevron) rather than looking like a plain browser dropdown. See Section 15, "The Story picker (dropdown)," for build notes.
>
...
> - **`data-japanese-scenes.js`** — all 30 (soon 40) Japanese Legends Story Scene images (`STORY_SCENES_JAPANESE`)
>
...
>
> **Latest build:** Japanese Legends Stories 21–30 (Rank 5 "Trusted Retainer" — Hachikazuki, Kaguya-hime, The Mirror of Matsuyama, Omusubi Kororin, Warashibe Choja — and Rank 6 "Honoured Samurai" — Yuki-onna, Kachi-kachi Yama, Setsubun, Why the Jellyfish Has No Bones, The Two Frogs of Osaka and Kyoto) are now built with full five-lesson cycles and Story Scene images, following the same `STORIES_JAPANESE`/`STORY_SCENES_JAPANESE` pattern as Stories 1–20, with zero architecture changes. 30 of the 40 Japanese Legends stories were built at that point (Ranks 1–6 complete); 10 stories remained (Section 9B).
>
> **Latest build — the Japanese Legends curriculum is complete:** Rank 7, "Elite Samurai" (Stories 31–35 — Benkei and the Bridge at Gojo, Hachiko's Promise, Sarukani Gassen, Tokoyo and the Sea Serpent, Musashi and the Duel at Ganryu Island) and Rank 8, "Master Samurai" (Stories 36–40 — Ninomiya Sontoku, Miyamoto Musashi's Final Lesson, The Legend of Mount Fuji, Kintoki: Kintaro Grown Tall, and the capstone Momotaro's Legacy: The Treasure Shared) are now built, using the exact same `STORIES_JAPANESE`/`STORY_SCENES_JAPANESE`/`setActiveStory()` architecture with zero new code — just ten more entries pushed into `STORIES_JAPANESE` plus their ten Story Scene images appended to `STORY_SCENES_JAPANESE[30..39]` in `data-japanese-scenes.js` (not re-embedded into `app.html`, preserving the three-file split). **All 40 stories, all 8 ranks, all 200 lessons of the Japanese Legends curriculum are now 100% built, playable, and printable — matching the fully-complete 40-story Bible Stories curriculum. Both curricula (80 stories, 400 lessons total) are now fully built.** The Christian-school vetting note (Section 9B) was applied carefully to both duel stories (#31 Benkei, #35 Musashi), which are told as bloodless, skill-and-character-focused contests, to Tokoyo's undersea shrine (#34, fantasy scenery, not a worshipped deity), and to the Mount Fuji legend (#38), whose elixir belongs to a thoughtful human emperor rather than any god.
...
Flipping the toggle only swaps which `STORIES` array is active (`STORIES_CHRISTIAN` vs `STORIES_JAPANESE`) and resets to that curriculum's Story 1 — it does not touch ranks, badges, backdrops, fonts, or any other art. Only the **Story Scene** hero image (Section 11.D) differs per curriculum, since it depicts a moment from that specific story. As of this build, **all 40 Japanese Legends stories (Momotaro through Momotaro's Legacy, all 8 ranks)** have the full 5-lesson interactive cycle built in the Japanese Legends curriculum, each with its own Story Scene image, matching the fully-complete 40-story Bible Stories curriculum — see Section 15.1.
...
**Vetted for a Christian-school setting:** since this app is used in a Christian school, every title below is a purely secular folktale — brave people, clever animals, kind strangers, magical creatures (kappa, tanuki, kitsune, tengu, dragons — treated as fantasy-story creatures, the same way a Western fairy tale uses elves or talking wolves, never as objects of worship). None of the 40 stories are myths about Shinto gods or goddesses (no Amaterasu, Susanoo, Izanagi/Izanami, Fujin/Raijin, or the Dragon King's divine court), and none retell a creation myth that could compete with Genesis — an earlier draft of this list included a few of those and they have been swapped out for equivalent secular legends (see Rank 4 #18, Rank 5 #21, and Rank 7–8 #33–37 below, all of which now feature ordinary human heroes instead). Two entries that reference an undersea "palace" purely as fantasy scenery (#9 Urashima Taro, #29 Why the Jellyfish Has No Bones) are written to be told as fantasy-kingdom stories, not as tales of a worshipped sea deity. This same vetting rule was applied carefully to Stories 11, 13, 17, and 19 when they were built: Inaba no Shirousagi's healer (#11) is a kind young traveller, not a god; The Stonecutter's wish-granting spirit (#13) is a fantasy magical being; Tawara Toda's dragon princess and undersea palace (#17) are fantasy-story scenery, and the centipede confrontation is bloodless and skill-focused; and the tengu in Yoshitsune's story (#19) is a fantasy forest guardian and mentor, never worshipped. The same care was applied again to Stories 22 and 29 when they were built: Kaguya-hime (#22) is told as a mysterious magical being of unknown origin, with any "moon" framing kept as pure fantasy rather than a deity to be worshipped, and the undersea kingdom's ruler in Why the Jellyfish Has No Bones (#29) is a fantasy-kingdom figure, not a worshipped sea deity's court. The same vetting was applied one final time to Stories 31–40 when they were built: both duel stories, Benkei and the Bridge at Gojo (#31) and Musashi and the Duel at Ganryu Island (#35), are told as bloodless, skill-and-character-focused contests with no graphic combat; Tokoyo's undersea shrine (#34) is fantasy-story scenery, not a worshipped sea deity's court, and the sea serpent is outwitted rather than fought; and The Legend of Mount Fuji (#38) gives its elixir of immortality to a thoughtful human emperor who chooses his loved ones over eternal life, never to a Shinto god. **All 40 stories (Ranks 1–8) are now built in the app — see Section 15.1. The Japanese Legends curriculum is 100% complete.** Each story below also has its **Story Scene image prompt** (matching the Section 11.D template, Master Style Block appended); all 40 stories have had their image generated and wired in.
...
### Rank 3 — Disciplined Warrior (Stories 11–15 / Lessons 51–75): Cleverness & Wit ✅ *built*
11. **Inaba no Shirousagi (The White Rabbit of Inaba)** ✅ — *"A silhouetted rabbit hopping lightly across the backs of a line of silhouetted crocodiles spanning a strait of water, a distant shoreline and glowing sunrise circle ahead."* (the healer is told as a kind young traveller, not a worshipped god, per the vetting note below)
...
13. **The Stonecutter** ✅ — *"A silhouetted stonecutter standing on a mountainside with his chisel, looking up at a huge glowing sunset circle framed between two peaks, simple tools resting at his feet."* (the wish-granting spirit is told as a fantasy magical being, not a worshipped deity)
...
### Rank 4 — Skilled Ronin (Stories 16–20 / Lessons 76–100): Courage & Strength ✅ *built*
...
17. **Tawara Toda (The Rice-Bag Warrior)** ✅ — *"A silhouetted warrior standing calmly on a wooden bridge facing a huge coiled centipede silhouette stretching across distant mountains, glowing sunset circle behind the peaks."* (the dragon princess and her undersea palace are told as fantasy-story scenery, never a worshipped sea deity's court, and the centipede confrontation is kept bloodless and skill-focused)
...
19. **Yoshitsune and the Tengu of Mt. Kurama** ✅ — *"A silhouetted young boy practising with a wooden sword on a forest mountainside, a tall winged tengu figure with a long nose watching and guiding him, glowing sunset circle through the pine trees."* (the tengu is told as a fantasy forest guardian spirit and mentor, never a worshipped deity)
...
### Rank 5 — Trusted Retainer (Stories 21–25 / Lessons 101–125): Wisdom & Patience ✅ *built*
...
22. **Kaguya-hime (The Bamboo Princess)** ✅ — *"A silhouetted bamboo cutter kneeling before a glowing stalk of bamboo split open to reveal a tiny princess silhouette inside, a bamboo grove stretching into the distance, glowing sunset circle behind the stalks."* (told as a purely secular fantasy story — she is a mysterious magical being of unknown origin returning to a faraway realm, never a moon deity to be worshipped)
...
### Rank 6 — Honoured Samurai (Stories 26–30 / Lessons 126–150): Structure & Consequence ✅ *built*
26. **Yuki-onna (The Snow Woman)** ✅ — *"A silhouetted woman made of falling snow standing quietly in a snow-covered forest at dusk, cold pale-blue and pink gradient sky behind her, faint glowing moon overhead."* (told gently and atmospherically, focused on mystery and keeping one's word, not horror)
...
28. **Setsubun: The Night the Village Drove Away the Oni** ✅ — *"A silhouetted family standing in a doorway throwing handfuls of beans toward two fleeing oni silhouettes outside, glowing warm light from the house against a dusk sky."* (the oni are mischievous, non-scary trouble-making figures, not demons of horror)
29. **Why the Jellyfish Has No Bones** ✅ — *"A silhouetted jellyfish drifting through a coral reef beside playful fish shapes, sunlight beams filtering down from the surface above, glowing warm sunset colour wash through the water."* (a light just-so animal-origin fable; the undersea kingdom's ruler is told as a fantasy-kingdom figure, not tied to any deity's court)
...
### Rank 7 — Elite Samurai (Stories 31–35 / Lessons 151–175): Loyalty & Honour ✅ *built*
31. **Benkei and the Bridge at Gojo** ✅ — *"Two silhouetted warrior figures facing each other on a curved wooden bridge, one young and slight, one tall carrying a naginata pole-arm at rest, glowing sunset circle behind the bridge's railing."* (the "duel" is told as a bloodless, skill-and-respect-focused contest, never graphic combat)
32. **Hachiko's Promise** ✅ — *"A silhouetted dog sitting patiently outside a train station entrance at dusk, silhouettes of commuters passing by in the distance, glowing warm station lights and a sunset sky behind."* (told warmly, focused on loyalty and community rather than dwelling on grief)
33. **Sarukani Gassen (The Monkey and the Crab)** ✅ — *"A silhouetted crab standing bravely beside a chestnut, a bee, and a large stone mortar, facing a startled monkey silhouette up in a persimmon tree, glowing sunset circle behind the branches."* (the friends' "trick" on the monkey is kept comedic and harmless — startling, never injurious)
34. **Tokoyo and the Sea Serpent** ✅ — *"A silhouetted girl diving into the sea with a dagger at her side, a huge serpent silhouette coiling in the depths below her, glowing sunset light filtering down through the waves above."* (Tokoyo outwits the serpent with cleverness rather than fighting it, and the undersea shrine is told as fantasy scenery, not a worshipped sea deity's court)
35. **Musashi and the Duel at Ganryu Island** ✅ — *"Two silhouetted swordsmen facing each other on a narrow sandy shoreline, one holding a long wooden sword carved from an oar, a small boat pulled up on the sand behind him, glowing sunrise circle low over the water."* (the "duel" is kept brief, bloodless, and skill/psychology-focused)

### Rank 8 — Master Samurai (Stories 36–40 / Lessons 176–200): Legacy & Mastery ✅ *built*
...
38. **The Legend of Mount Fuji** ✅ — *"A silhouetted elixir jar resting on a mountain summit with a thin trail of smoke rising into the sky, the huge silhouette of Mount Fuji's peak below, glowing sunrise circle beside the mountain."* (told as a poetic nature-origin legend; the elixir belongs to a thoughtful human emperor who chooses his loved ones over eternal life, never a Shinto god)
...
- [x] Build out the Japanese Legends curriculum's Stories 1–10 (Rank 1, "Apprentice Samurai," Foundation Tales, and Rank 2, "Novice Swordsman," Gratitude & Kindness) — done, with zero architecture changes: Stories 2–10 (Issun-boshi, Shita-kiri Suzume, Hanasaka Jiisan, Kobutori Jiisan, Tsuru no Ongaeshi, Kasa Jizo, Bunbuku Chagama, Urashima Taro, Kappa no Sara) pushed into `STORIES_JAPANESE` following the exact `story_content_6to10.py`-style shape, and Story 1 (Momotaro) got its first-ever Story Scene image alongside 9 new ones for Stories 2–10, replacing the old `STORY_SCENES_JAPANESE = [null]` placeholder. Urashima Taro (#9) is told as a pure fantasy undersea-kingdom story about the passage of time and keeping promises, per the Section 9B vetting note (no deity/ruler-worship framing).
- [x] Extend the same pattern to the Japanese Legends curriculum's Stories 11–20 (Rank 3, "Disciplined Warrior," Cleverness & Wit, and Rank 4, "Skilled Ronin," Courage & Strength) — done, with zero architecture changes: Stories 11–20 (Inaba no Shirousagi, The Boy Who Drew Cats, The Stonecutter, Nezumi no Yomeiri, Obasute Yama, Kintaro, Tawara Toda, Sannen Netaro, Yoshitsune and the Tengu of Mt. Kurama, The Grateful Fox) pushed into `STORIES_JAPANESE`, plus their 10 Story Scene images appended to `STORY_SCENES_JAPANESE[10..19]` in `data-japanese-scenes.js` (not re-embedded into `app.html`, preserving the file split). The Christian-school vetting note was applied carefully to Stories 11, 13, 17, and 19, each of which has a magical/supernatural helper figure (see Section 9B for details).
- [x] Extend the same pattern to the Japanese Legends curriculum's Stories 21–30 (Rank 5, "Trusted Retainer," Wisdom & Patience, and Rank 6, "Honoured Samurai," Structure & Consequence) — done, with zero architecture changes: Stories 21–30 (Hachikazuki, Kaguya-hime, The Mirror of Matsuyama, Omusubi Kororin, Warashibe Choja, Yuki-onna, Kachi-kachi Yama, Setsubun, Why the Jellyfish Has No Bones, The Two Frogs of Osaka and Kyoto) pushed into `STORIES_JAPANESE`, plus their 10 Story Scene images appended to `STORY_SCENES_JAPANESE[20..29]` in `data-japanese-scenes.js` (not re-embedded into `app.html`, preserving the file split). The Christian-school vetting note was applied carefully to Kaguya-hime (#22, a mysterious magical being rather than a moon deity) and Why the Jellyfish Has No Bones (#29, a fantasy-kingdom ruler rather than a worshipped sea deity); Yuki-onna (#26) was kept gentle and atmospheric rather than frightening, and the oni in Setsubun (#28) are mischievous festival figures rather than demons. 30 of the Japanese Legends curriculum's 40 stories were built at that point (Ranks 1–6 complete); Stories 31–40 remained (10 stories).
- [x] Extend the same pattern to the Japanese Legends curriculum's Stories 31–40 (Rank 7, "Elite Samurai," Loyalty & Honour, and Rank 8, "Master Samurai," Legacy & Mastery) — done, with zero architecture changes: Stories 31–40 (Benkei and the Bridge at Gojo, Hachiko's Promise, Sarukani Gassen, Tokoyo and the Sea Serpent, Musashi and the Duel at Ganryu Island, Ninomiya Sontoku, Miyamoto Musashi's Final Lesson, The Legend of Mount Fuji, Kintoki: Kintaro Grown Tall, Momotaro's Legacy: The Treasure Shared) pushed into `STORIES_JAPANESE`, plus their 10 Story Scene images appended to `STORY_SCENES_JAPANESE[30..39]` in `data-japanese-scenes.js` (not re-embedded into `app.html`, preserving the file split). The Christian-school vetting note was applied carefully to both duel stories (#31 Benkei, #35 Musashi, told as bloodless, skill-and-character-focused contests), to Tokoyo's undersea shrine (#34, fantasy scenery rather than a worshipped sea deity's court, with the serpent outwitted rather than fought), and to The Legend of Mount Fuji (#38, whose elixir belongs to a thoughtful human emperor rather than any Shinto god); Hachiko's Promise (#32) was kept warm and focused on loyalty and community rather than dwelling on grief, and the animal friends' "trick" on the greedy monkey in Sarukani Gassen (#33) is comedic and harmless, never injurious. **All 40 of the Japanese Legends curriculum's stories are now built (all 8 ranks complete). Both the Bible Stories and Japanese Legends curricula are now 100% complete — 80 total stories, 400 total lessons across both curricula.**
...
- Not yet built: the belt ceremony animation, XP/streak systems, Master's Wall gallery, the final certificate generator, and the remaining 10 Japanese Legends stories (Section 9B; Stories 1–30, Ranks 1–6, now have their full interactive cycle built) — see the Quick Build Checklist in Section 12
...
### The Story picker (dropdown)

Originally this was a wrapping row of pill buttons, one per built story (`.story-tabs-nav` / `.story-tab-btn`). Once the Bible Stories curriculum reached 40 stories, that row got long and cluttered the page, so it was replaced with a single **dropdown `<select>`** (`#storySelect`, inside a styled wrapper `#storyTabsNav`/`.story-select-wrap`) that lists every story as `"Story N · Title"`. The dropdown is custom-styled (not the browser default look) to match the rest of the app: dark purple-to-ink gradient fill, cream text, rounded corners, an "orange glow" focus ring on `:focus` (matching the site's `--orange` accent), and a hand-drawn CSS chevron instead of the native arrow (`.story-select{appearance:none}` + a small rotated-border `::after` chevron). A small uppercase "Choose a story" label sits above it, in the same muted small-caps style used elsewhere in the app.

`buildStoryTabsNav()` now populates `<option>` elements instead of `<button>` elements, and a single `storySelect.onchange` handler calls `setActiveStory(parseInt(storySelect.value, 10))` — the same function as before, unchanged. `setActiveStory(idx)` keeps the dropdown in sync by setting `storySelect.value = String(idx)` (replacing the old code that toggled an `.active` class across a list of button children). The lesson tab bar underneath it (Lesson 1–5, still buttons — there are only ever 5, so they don't need a dropdown) still resets to Lesson 1 on every story switch, same as before. Switching curricula (Bible Stories ⇄ Japanese Legends) calls `buildStoryTabsNav()` again, which clears and rebuilds the dropdown's options for whichever `STORIES` array is now active, then `setActiveStory(0)` resets the selection to the first story — so the dropdown always shows the right story list with no leftover options from the other curriculum. This scales cleanly however many stories are built (currently 40 Bible Stories, 10 Japanese Legends, eventually up to 40 each) with zero further CSS or layout changes needed.
...
### Build notes for Japanese Legends Stories 11–20 (Rank 3 "Disciplined Warrior" and Rank 4 "Skilled Ronin")

Stories 11–20 (Inaba no Shirousagi, The Boy Who Drew Cats, The Stonecutter, Nezumi no Yomeiri, Obasute Yama, Kintaro, Tawara Toda, Sannen Netaro, Yoshitsune and the Tengu of Mt. Kurama, The Grateful Fox) were authored to the same `scrolls`/`searchWords`/`orderEvents`/`factStatements`/`para` shape as `STORIES_JAPANESE[0..9]`, with `factStatements` verified as plain strings (not `[text, bool]` tuples) against the live `app.html` shape before writing any content. All 10 new stories were appended to `STORIES_JAPANESE` via a surgical `str.replace` injection anchored on Kappa no Sara's closing `starter` string, with `app.html` backed up first (`app.html.bak_before_jp_11to20`).

This batch is the first Japanese Legends batch built **after** the image-array file split (Section 2.1/architecture note at the top of this doc): the 10 new Story Scene images were appended directly to `STORY_SCENES_JAPANESE[10..19]` inside `data-japanese-scenes.js` via its own separate `str.replace` injection (anchored on the array's closing `];`), never re-embedded into `app.html` — `app.html` only gained the 10 new story-text entries. `data-japanese-scenes.js` was backed up first (`data-japanese-scenes.js.bak_before_11to20`). Both files were re-verified with `node --check` after injection (the file is plain JS and checks cleanly on its own; `app.html`'s extracted inline `<script>` also checks cleanly), and both `STORIES_JAPANESE` (20 entries, `storyNumber` 1–20) and `STORY_SCENES_JAPANESE` (20 data-URI entries) were reloaded and parsed to confirm order and count.

The Christian-school vetting note (Section 9B) required particular care in this batch, since four of these ten stories feature a magical or supernatural helper figure: Inaba no Shirousagi's healer is written as a kind young traveller (given the name "Yoshi") rather than the deity of the traditional tale; The Stonecutter's wish-granting spirit is a fantasy magical being tied to the mountain, never worshipped; Tawara Toda's dragon princess and her undersea palace are told as pure fantasy-kingdom scenery (matching the Urashima Taro precedent from Stories 1–10), and the giant-centipede confrontation is kept bloodless and skill-focused, resolved by a clever detail (saliva on an arrow) rather than any graphic violence; and the tengu who secretly trains Yoshitsune is written as a fantasy forest guardian spirit and mentor, never an object of worship.

Level III ("Master Scroll") word counts again needed active trimming during authoring, echoing the Stories 1–10 build note: several early drafts for Stories 11–15 ran 650–910 words, well above the established per-page print budget (Story 9 "Urashima Taro," at 660 words, was the previous highest safely-printing precedent for this curriculum). Story 13 (The Stonecutter) and Story 15 (Obasute Yama) needed the heaviest cuts, from roughly 860–880 words down to 518–664 words, and Story 14 (Nezumi no Yomeiri) was trimmed from 746 to 594 words, all done by tightening redundant modifiers and repeated appositive phrases while preserving every plot beat, then re-verified word-by-word before injection. Stories 16–20 were authored within budget from the start (509–623 words for Level III).

Re-tested end to end after adding Japanese Legends Stories 11–20: `node --check` passes cleanly on both `app.html`'s extracted `<script>` and on `data-japanese-scenes.js` directly; both arrays parse as valid JSON/JS with all entries in order; with Playwright (chromium, served over a local `python3 -m http.server`, not `file://`, to match real multi-file GitHub Pages deployment), the curriculum toggle correctly shows 20 story options in the `#storySelect` dropdown for Japanese Legends, and selecting Stories 11, 15, and 19 confirmed each one's title renders in the dropdown, its Story Scene shows (`.has-image` on `#storyScene`, with a valid non-trivial `src`), and its comprehension fact chips render (4 per story, via `#factChips .chip`), all with zero console/JS errors (ignoring expected sandbox network/font blocks); switching back to Bible Stories confirmed all 40 Christian stories still render correctly via the dropdown (regression check, since that curriculum was already 100% complete and needed to stay untouched); and print-testing (pypdf, with Playwright's `page.pdf(print_background=True)`) the reading (all 3 levels) for Stories 13 and 18 confirmed the page-count limit held at exactly 3 pages per story reading (one per scroll level), with no further trimming needed after the authoring-stage word-count work above.

**With this batch, 20 of the Japanese Legends curriculum's 40 stories are built (Ranks 1–4, all with Story Scene art); Stories 21–40 (Ranks 5–8) remain to be written.**

### Build notes for Japanese Legends Stories 21–30 (Rank 5 "Trusted Retainer" and Rank 6 "Honoured Samurai")

Stories 21–30 (Hachikazuki, Kaguya-hime, The Mirror of Matsuyama, Omusubi Kororin, Warashibe Choja, Yuki-onna, Kachi-kachi Yama, Setsubun, Why the Jellyfish Has No Bones, The Two Frogs of Osaka and Kyoto) were authored to the same `scrolls`/`searchWords`/`orderEvents`/`factStatements`/`para` shape as `STORIES_JAPANESE[0..19]`, with `factStatements` verified as plain strings (not `[text, bool]` tuples, and never graded true/false by the app) against the live `app.html` shape before writing any content, and `remove` list lengths (5–6 phrases per paragraph) verified against the actual Stories 11–20 precedent rather than assumed. All 10 new stories were appended to `STORIES_JAPANESE` via a surgical `str.replace` injection anchored on The Grateful Fox's closing `starter` string, with `app.html` backed up first (`app.html.bak_before_jp_21to30`).

The 10 new Story Scene images were appended directly to `STORY_SCENES_JAPANESE[20..29]` inside `data-japanese-scenes.js` via its own separate `str.replace` injection (anchored on the array's closing `];`), never re-embedded into `app.html` — `app.html` only gained the 10 new story-text entries. `data-japanese-scenes.js` was backed up first (`data-japanese-scenes.js.bak_before_21to30`). Source images were resized to 900px wide and compressed to webp (quality tuned per image, landing between roughly 61KB and 66KB, matching the Stories 11–20 precedent). Both files were re-verified with `node --check` after injection, and both `STORIES_JAPANESE` (30 entries, `storyNumber` 1–30) and `STORY_SCENES_JAPANESE` (30 data-URI entries) were reloaded and parsed to confirm order and count.

The Christian-school vetting note (Section 9B) required particular care for two stories in this batch: Kaguya-hime (#22) is told as a mysterious magical being of unknown origin who returns to a faraway realm at the story's end, with any "moon" imagery kept as pure, unworshipped fantasy scenery rather than a lunar deity; and the ruler of the undersea kingdom in Why the Jellyfish Has No Bones (#29) is written as a fantasy-kingdom figure handing out an errand, never a worshipped sea deity's court, echoing the Urashima Taro (#9) precedent. Yuki-onna (#26) was deliberately kept atmospheric and gentle rather than frightening — the snow woman spares the young woodcutter and the story's tension sits in a kept promise, not horror. Setsubun (#28) keeps its oni as cheerful, mischievous festival figures that scamper away comically when pelted with beans, never demons of horror. Kachi-kachi Yama (#27) keeps the rabbit's "lesson" to the tanuki bloodless and comedic — a cracking clay boat and an unplanned swim, not injury.

Level III ("Master Scroll") word counts were checked against the Stories 11–20 precedent (280–664 words) as they were written, landing between 434 and 622 words across all 10 new stories — within budget from the start, with no post-hoc trimming needed.

Re-tested end to end after adding Japanese Legends Stories 21–30: `node --check` passes cleanly on both `app.html`'s extracted `<script>` and on `data-japanese-scenes.js` directly; both arrays parse as valid JSON/JS with all entries in order; with Playwright (chromium, served over a local `python3 -m http.server`, not `file://`), the curriculum toggle correctly shows 30 story options in the `#storySelect` dropdown for Japanese Legends, and selecting Stories 21, 25, and 30 (dropdown indices 20, 24, 29) confirmed each one's Story Scene shows (`.has-image` on `#storyScene`) with zero console/JS errors (ignoring expected sandbox network/font blocks); switching back to Bible Stories confirmed all 40 Christian stories still render correctly via the dropdown (regression check); and print-testing (pypdf, with Playwright's `page.pdf(print_background=True)`) both the reading (all 3 levels) and the printable worksheet for Stories 21 and 25 confirmed the page-count limits held — exactly 3 pages per story reading (one per scroll level) and 2 pages per worksheet — with no trimming needed.

**With this batch, 30 of the Japanese Legends curriculum's 40 stories are built (Ranks 1–6, all with Story Scene art); Stories 31–40 (Ranks 7–8) remain to be written.**
...
- **`data-japanese-scenes.js`** holds `var STORY_SCENES_JAPANESE = [...]` — all 30 (soon 40) Japanese Legends hero images, indexed to match `STORIES_JAPANESE`.
